...
# SDMA的一开始能被prefill掩盖一些，差距要小一点
# 负载越高MTE转成SDMA的就越多，ttft上升就越多，P99上升的更快
# DS的有小包硬用mte串行发，比QW的P99在高负载下好一些，因为
# avg：QW的低负载时差距大一些，但是高负载时最大吞吐也上去的快
    ...
    "deepseek": {
        "avg": {
            "32K Prefix": panel(
                ...
                mc_r=[710, 820, 1001, 1894],
                mc_s=[511, 569, 600, 648, 711, 820, 1425, 3074],
                ours=[416, 415, 459, 470, 510, 573, 660, 760, 834, 2100],
                ylim=[300, 1100],
                band_scale=0.11,
            ),
            "15K Prefix": panel(
                ...
                mc_r=[600, 660, 770, 910, 1494, 3100],
                mc_s=[479, 509, 519, 538, 579, 640, 770, 1325, 4111],
            ...
            "8K Prefix": panel(
                qps=[45, 60, 75, 90, 105, 120, 135, 150, 165, 180, 195],
                display_qps=[60, 100, 140, 180],
                mc_r=[550, 580, 630, 690, 770, 910, 1101, 4100],
                mc_s=[400, 410, 449, 469, 538, 619, 720, 900, 1800],
        ...
        "p99": {
            "32K Prefix": panel(
                ...
                mc_s=[1689, 1799, 1700, 1858, 2011, 2920, 11425],
                ours=[1116, 1425, 1379, 1573, 1660, 2060, 2600, 11000],
                ylim=[800, 3000],
                band_scale=0.18,
            ),
            "15K Prefix": panel(
                ...
                mc_s=[1589, 1699, 1618, 1858, 1911, 2220, 4425],
                ours=[1090, 1199, 1390, 1473, 1590, 1860, 2134, 9100],
                ylim=[800, 3000],
                band_scale=0.15,
            ),
            "8K Prefix": panel(
                ...
                display_qps=[60, 100, 140],
                mc_r=[1590, 2190, 2500, 3100, 8323],
                mc_s=[1289, 1199, 1218, 1558, 1611, 1820, 2425, 6425],
                ours=[890, 1091, 1049, 1120, 1290, 1373, 1560, 2260, 3101, 11000],
                ylim=[800, 3000],
                band_scale=0.15,
            ),
        },
    ...
    "qwen": {
        "avg": {
            "32K Prefix": panel(
                ...
                display_qps=[60, 100, 140],
                mc_r=[940, 1020, 1894],
                mc_s=[649, 709, 778, 758, 920, 1425, 3074],
                ours=[456, 445, 469, 510, 573, 680, 840, 1134, 2100],
                ylim=[300, 1200],
                band_scale=0.11,
            ),
            "15K Prefix": panel(
                ...
                mc_s=[569, 619, 669, 738, 810, 940, 1325, 4111],
            ...
            "8K Prefix": panel(
                ...
                mc_s=[469, 539, 539, 569, 638, 720, 850, 1040, 4100],
                ours=[386, 395, 389, 400, 410, 470, 580, 850, 1159, 2510],
                ylim=[300, 1200],
                band_scale=0.09,
            ),
        },
        "p99": {
            "32K Prefix": panel(
                ...
                mc_s=[1889, 2199, 2000, 2458, 4811, 11425],
                ours=[1116, 1225, 1379, 1973, 3160, 5960, 12600],
                ylim=[800, 5000],
                band_scale=0.22,
            ),
            "15K Prefix": panel(
                ...
                mc_s=[1729, 1699, 2018, 1958, 2611, 4120, 14425],
                ours=[990, 1199, 1490, 1433, 1810, 2460, 4234, 9100],
                ylim=[800, 5000],
                band_scale=0.20,
            ),
            "8K Prefix": panel(
                ...
                mc_s=[1489, 1599, 1718, 1918, 2011, 2720, 4425, 6425],
                ours=[890, 1091, 1049, 1320, 1590, 1873, 2560, 5100],
                ylim=[800, 5000],
                band_scale=0.18,
            ),
        },
